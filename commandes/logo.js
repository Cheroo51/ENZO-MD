...
zokou({ nomCom: "bera",
    ...
    if (!arg || arg == "") {
        repondre("*__Exemple : * " + prefixe + "𝐌𝐃𝐄𝐄");
        return;
    }
    try {
      ...
      //  let lien = "https://e1.yotools.net" + res;
        repondre("* processing...*");
        await zk.sendMessage(origineMessage, { image: { url:anu.image}, caption: "* \t *𝐋𝐨𝐠𝐨 𝐁𝐲 𝐕𝐄𝐀 𝐁𝐎𝐓*" }, { quoted: ms });
    }
    catch (e) {
        repondre("🥵🥵 " + e);
    }
...
zokou({ nomCom: "dragonball", categorie: "Logo", reaction: "🐉" }, async (dest, zk, commandeOptions) => {
    ...
    try {
       ...
       // var idImg = Object.values(imgInfo)[3];
        ...
        await zk.sendMessage(dest, { image: { url: imgInfo.image }, caption: "* \t *𝐋𝐨𝐠𝐨 𝐁𝐲 𝐕𝐄𝐀 𝐁𝐎𝐓*" }, { quoted: ms });
    }
    catch (e) {
        repondre("🥵🥵 " + e);
    }
...
zokou({ nomCom: "naruto", categorie: "Logo", reaction: "⛩" }, async (dest, zk, commandeOptions) => {
    ...
    try {
        ...
        await zk.sendMessage(dest, { image: { url: img.image }, caption: "\t\t *𝐋𝐨𝐠𝐨 𝐁𝐲 𝐕𝐄𝐀 𝐁𝐎𝐓*" }, { quoted: ms });
    }
    catch (e) {
        repondre("🥵🥵 " + e);
    }
...
repondre("  processing ...")
         await zk.sendMessage(dest,{image:{url:img.image},caption:"\t *𝐋𝐨𝐠𝐨 𝐁𝐲 𝐕𝐄𝐀 𝐁𝐎𝐓*"})
...
zokou({ nomCom: "gif×1", categorie: "Logo", reaction: "😋" }, async (dest, zk, commandeOptions) => {
  ...
  try {
    if (!arg || arg === "") {
      repondre(`${prefixe}gif×1 𝐕𝐄𝐀 𝐁𝐎𝐓`);
      return;
    }
    ...
    repondre("Processing...");
    await zk.sendMessage(dest, { image: { url: img }, caption: "*𝐋𝐨𝐠𝐨 𝐁𝐲 𝐕𝐄𝐀 𝐁𝐎𝐓*" }, { quoted: ms });
  } catch (e) {
    repondre(e);
  }
});
